...
- (void)viewDidLoad {
    ...
    [self.addEventButton setTitleColor:[UIColor accent_color] forState:UIControlStateNormal];
    [self.addEventButton setTitleColor:[UIColor accent_color] forState:UIControlStateHighlighted];
