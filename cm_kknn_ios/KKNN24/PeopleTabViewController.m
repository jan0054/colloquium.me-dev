...
{
    PersonCellTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"personcell"];
    ...
    cell.name_label.text = [NSString stringWithFormat:@"%@, %@",lastname, firstname];
    cell.institution_label.text = institution;
    if ([cell respondsToSelector:@selector(layoutMargins)]) {
        cell.layoutMargins = UIEdgeInsetsZero;
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.person_trim_view.backgroundColor = [UIColor accent_color];
    cell.person_card_view.backgroundColor = [UIColor light_bg];
    cell.person_card_view.alpha = 1;
    cell.person_card_view.layer.cornerRadius = 2;
    [cell.person_detail_button setTitleColor:[UIColor dark_button_txt] forState:UIControlStateNormal];
    [cell.person_detail_button setTitleColor:[UIColor dark_button_txt] forState:UIControlStateHighlighted];
    cell.name_label.textColor = [UIColor dark_txt];
    cell.institution_label.textColor = [UIColor secondary_text];
    
    //add shadow to views
    UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRect:cell.person_card_view.bounds];
    cell.person_card_view.layer.masksToBounds = NO;
    cell.person_card_view.layer.shadowColor = [UIColor blackColor].CGColor;
    cell.person_card_view.layer.shadowOffset = CGSizeMake(0.0f, 3.0f);
    cell.person_card_view.layer.shadowOpacity = 0.3f;
    cell.person_card_view.layer.shadowPath = shadowPath.CGPath;
