...
public class AbstractDetailsActivity extends BaseActivity {
	...
	public static final String 		EXTRA_ABSTRACT_AUTHOR_INSTITUTION = "com.squint.data.abstract.AUTHOR_INSITUTION";
	public static final String 		EXTRA_ABSTRACT_AUTHOR_EMAIL		  = "com.squint.data.abstract.AUTHOR_EMAIL";
	public static final String 		EXTRA_ABSTRACT_AUTHOR_WEBSITE	  = "com.squint.data.abstract.AUTHOR_WEBSITE";
	...
	public void onResume() {
		...
		absId = intent.getStringExtra(EXTRA_ABSTRACT_ID);
		
		authorId	= intent.getStringExtra(EXTRA_ABSTRACT_AUTHOR_ID);
		author		= intent.getStringExtra(EXTRA_ABSTRACT_AUTHOR);
		institution	= intent.getStringExtra(EXTRA_ABSTRACT_AUTHOR_INSTITUTION);
		website		= intent.getStringExtra(EXTRA_ABSTRACT_AUTHOR_WEBSITE);
		email		= intent.getStringExtra(EXTRA_ABSTRACT_AUTHOR_EMAIL);
